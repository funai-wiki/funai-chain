...
| [`2026-04-27-2003-runpod-moe-phase1-rtxpro6000/`](reports/2026-04-27-2003-runpod-moe-phase1-rtxpro6000/report.md) | 2026-04-27 | **PASS (narrowly)** — V6 PoC Phase 1 MoE on RunPod RTX PRO 6000 Blackwell. Qwen MoE 9/9, DeepSeek-V2-Lite 8/9 (one FAIL is PoC instrumentation gap, not protocol). **Amended 2026-04-28 (§0 Correction)** — original "Phase 1c dynamic batch" claim was overstated; the test driver called the dynamic-batch API but with a static schedule. P0 follow-ups (true dynamic batch + ChaCha20, cross-hardware A2, AWQ quantized) added to `Pre_Mainnet_Test_Plan.md` §2.8. |
